...
+ (NSArray *)initUnits {
    NSArray *units = [[NSArray alloc] initWithObjects:
                    ...
                    ,[[unit alloc] initWithName:@"Square meter" category:Area abbr:@"m^2" sortOrder:1 rate:1 selectedAs:1]
                    ,[[unit alloc] initWithName:@"Square feet" category: Area abbr:@"ft^2" sortOrder:2 rate:0.092903 selectedAs:2]
                      ...
                      ,[[unit alloc] initWithName:@"Square Kilometer" category: Area abbr:@"km^2" sortOrder:5 rate:1000000 selectedAs:0]
                      ,[[unit alloc] initWithName:@"Square Inch" category: Area abbr:@"in^2" sortOrder:6 rate:0.00064516 selectedAs:0]
                      ,[[unit alloc] initWithName:@"Square Yard" category: Area abbr:@"yd^2" sortOrder:7 rate:0.836127 selectedAs:0]
                      ,[[unit alloc] initWithName:@"Square Mile" category: Area abbr:@"mile^2" sortOrder:8 rate:2589990 selectedAs:0]
                    ...
                    ,[[unit alloc] initWithName:@"US Gallon" category: Volumn abbr:@"gal" sortOrder:2 rate:3.78541178 selectedAs:2]
                      ,[[unit alloc] initWithName:@"Cubic Meter" category: Volumn abbr:@"m^3" sortOrder:3 rate:1000 selectedAs:0]
                      ,[[unit alloc] initWithName:@"Cubic Foot" category: Volumn abbr:@"ft^3" sortOrder:4 rate:28.3168 selectedAs:0]
                      ,[[unit alloc] initWithName:@"Cubic Inch" category: Volumn abbr:@"in^3" sortOrder:5 rate:0.0163871 selectedAs:0]
